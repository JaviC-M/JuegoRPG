...
| CU-4           | Jugador           | Elegir combatir contra enemigo            | El jugador selecciona la opción de luchar desde el menú principal para iniciar un combate.                                    | RF-1.1, RF-1.2                         |
...
| CU-9           | Sistema / Jugador | Detectar victoria o derrota               | El sistema determina si el jugador gana o pierde el combate y aplica consecuencias como oro, subida de nivel o fin del juego. | RF-3.4, RF-3.5, RF-4.3, RF-4.4, RF-2.5, RF-4.5 |
...
| CU-12          | Jugador           | Elegir ver estadísticas o salir del juego | El jugador puede consultar sus estadísticas o seleccionar salir del juego desde el menú principal.                            | RF-1.1, RF-1.4, RF-1.5, RF-2.6         |
